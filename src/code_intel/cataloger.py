...
def build_catalog(repo_path: str | Path, database_path: str | Path | None = None) -> CatalogResult:
    """Build a repository catalog and persist it to SQLite."""
    ...
    store.write_catalog(analyses, metadata)
